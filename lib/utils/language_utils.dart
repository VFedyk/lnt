...
String localizedLangName(AppLocalizations l10n, String code) =>
    switch (code.toLowerCase()) {
      ...
      'yue' => l10n.langCantonese,
      'la' => l10n.langLatin,
      'grc' => l10n.langAncientGreek,
      'sa' => l10n.langSanskrit,
      'ang' => l10n.langOldEnglish,
      'non' => l10n.langOldNorse,
      'lzh' => l10n.langLiteraryChinese,
      'eo' => l10n.langEsperanto,
      'tlh' => l10n.langKlingon,
      'got' => l10n.langGothic,
      'sux' => l10n.langSumerian,
      'cu' => l10n.langOldChurchSlavonic,
      'qya' => l10n.langQuenya,
      'sjn' => l10n.langSindarin,
      'ia' => l10n.langInterlingua,
      'jbo' => l10n.langLojban,
      _ => code,
    };
