...
import '../../controllers/base_term_search_dialog_controller.dart';
...
class _BaseTermSearchDialogState extends State<BaseTermSearchDialog>
  ...
  late final BaseTermSearchDialogController _controller;
  ...
  void initState() {
    super.initState();
    _controller = BaseTermSearchDialogController(
      languageId: widget.languageId,
      excludeTermId: widget.excludeTermId,
    );
  ...
  Future<void> _handleAddTranslation(Term term) async {
    ...
    await _controller.addTranslationToTerm(term, result);
  }

  Future<void> _handleCreateNewBaseTerm() async {
    final termText = _searchController.text.trim().toLowerCase();
    if (termText.isEmpty) return;
    final created = await _controller.createNewBaseTerm(
      termText,
                ...
                Flexible(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final term = _controller.searchResults[index];
                      final translations = term.id != null
                          ? _controller.translationsMap[term.id!]
                          : null;
                      final subtitle =
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () => _handleAddTranslation(term),
                        ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: AppConstants.spacingS),
                      ElevatedButton.icon(
                        onPressed: _handleCreateNewBaseTerm,
